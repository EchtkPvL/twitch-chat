...
$player = empty($_GET['player']) ? 'echtkpvl' : $_GET['player'];
    ...
    <body>
        <div class="container" style="max-width:100%;margin-right:unset;margin-left:unset;">
            ...
            <div class="row" id="head">
                ...
                <div class="col-6">
                    <input class="form-control" type="text" id="msg" name="msg" value="!points"></input>
                </div>
                <div class="col-3">
            ...
            <div class="row">
                <div class="col-4 chat hoch"><ul id="main"></ul></div>
                <div class="col-8 hoch" id="stream"></div>
            </div>
        ...
        <script>
            ...
            function genLi(text, channel='', user='', highlight='') {
...
<?php foreach($channels as $channel){ printf("                    '%s',\n", $channel); }?>
            ...
            client.on("message", (channel, user, message, self) => {
                ...
                if(user["badges-raw"] !== null && user["badges-raw"].includes("broadcaster")) highlight = "text-success";
                if(message.toLowerCase().includes(botname)) highlight = "bg-success text-white";

                $("#main").prepend(genLi(formatEmotes(message, user['emotes']), channel, user['display-name'], highlight));
            });
        ...
        <script type="text/javascript">
            var player = new Twitch.Player("stream", {
                width: '100%',
                height: '100%',
                channel: '<?php echo $player; ?>',
            });
